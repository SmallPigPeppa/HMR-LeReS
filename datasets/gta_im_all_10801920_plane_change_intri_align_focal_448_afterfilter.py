...
class GTADataset(Dataset):
    def __init__(self, data_dir, flip_prob=0.):
        ...
        self.leres_transforms = T.Compose([T.Resize((self.leres_size[0], self.leres_size[1])), T.ToTensor(),
                                           T.Normalize((0.3118, 0.2885, 0.2801), (0.2216, 0.2207, 0.2189))])
        self.leres_transforms_448 = T.Compose(
            [T.Resize((448, 448)), T.ToTensor(), T.Normalize((0.3118, 0.2885, 0.2801), (0.2216, 0.2207, 0.2189))])
    ...
    def __getitem__(self, index):
        ...
        return {
            ...
            'leres_image_448': self.leres_transforms_448(leres_image),
