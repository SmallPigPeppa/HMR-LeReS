...
/root/miniconda3/envs/hmr-leres/bin/python main_all_plane_origin_align_fix_pretrain_kptsfilter.py \
...
--ckpt_dir hmr-leres-ckpt-debug/v8.0-fix-pretrain-kptsfilter \
--name fix-pretrain-kptsfilter \
