...
class HMR(pl.LightningModule):
    ...
    def training_step(self, batch, batch_index):
        ...
        predict_smpl_thetas = self.hmr_generator(hmr_images)
        ...
        loss_shape = self.hmr_loss.batch_shape_l2_loss(gt_smpl_shapes, predict_smpl_shapes) * args.e_shape_weight
        loss_pose = self.hmr_loss.batch_pose_l2_loss(gt_smpl_poses, predict_smpl_poses) * args.e_pose_weight
