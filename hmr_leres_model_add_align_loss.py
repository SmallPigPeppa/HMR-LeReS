...
class HMRLeReS(pl.LightningModule):
    ...
    def training_step(self, batch, batch_index):
        ...
        self.manual_backward(log_dict['loss_generator']+log_dict['loss_leres'])
        torch.nn.utils.clip_grad_norm_(self.hmr_generator.parameters(), max_norm=5.0)
        torch.nn.utils.clip_grad_norm_(self.leres_model.parameters(), max_norm=5.0)
    ...
    def configure_optimizers(self):
        ...
        # hmr_generator_leres_sche = LinearWarmupCosineAnnealingLR(
        ...
        # )
        hmr_generator_leres_sche = torch.optim.lr_scheduler.StepLR(
            hmr_generator_leres_opt,
            step_size=500,
            gamma=0.9
        )
        ...
        return [hmr_generator_leres_opt, hmr_discriminator_opt], [hmr_generator_leres_sche, hmr_discriminator_sche]
