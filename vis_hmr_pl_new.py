...
if __name__=='__main__':
    ...
    ckpt_path= 'hmr-ckpt-v6.0/last-v2.ckpt'
    ...
    hmr_model.smpl_model.save_obj(verts=verts[0], obj_mesh_name='gt_mesh.obj')
    ...
    kpts_3d += transl.unsqueeze(dim=1)
    verts += transl.unsqueeze(dim=1)
    hmr_model.smpl_model.save_obj(verts=verts[0], obj_mesh_name='debug_mesh.obj')
    print('finished')