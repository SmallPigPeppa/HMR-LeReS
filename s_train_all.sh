...
#--ckpt_dir hmr-leres-ckpt-debug/10801920-norm \
#--name v8.0-10801920-norm \
...
/root/miniconda3/envs/hmr-leres/bin/python main_all_plane_origin_align_fixall_pretrain.py \
--smpl-mean-theta-path HMR/HMR-data/neutral_smpl_mean_params.h5 \
--smpl-model HMR/HMR-data/neutral_smpl_with_cocoplus_reg.txt \
--gta_dataset_dir /mnt/mmtech01/dataset/vision_text_pretrain/gta-im \
--mesh_dataset_dir /mnt/mmtech01/dataset/vision_text_pretrain/gta-im \
--ckpt_dir hmr-leres-ckpt-debug/fixall-pretrain-448 \
--name fixall-pretrain-448 \
--project HMR-LeReS-v8.0 \
--entity pigpeppa \
--num_gpus 8 \
--max-epochs 100 \
...
#
#
#/root/miniconda3/envs/hmr-leres/bin/python main_all_plane_origin_align_nofix_pretrain.py \
#--smpl-mean-theta-path HMR/HMR-data/neutral_smpl_mean_params.h5 \
#--smpl-model HMR/HMR-data/neutral_smpl_with_cocoplus_reg.txt \
#--gta_dataset_dir /mnt/mmtech01/dataset/vision_text_pretrain/gta-im \
#--mesh_dataset_dir /mnt/mmtech01/dataset/vision_text_pretrain/gta-im \
#--ckpt_dir hmr-leres-ckpt-debug/nofix-pretrain-448 \
#--name nofix-pretrain-448 \
#--project HMR-LeReS-v8.0 \
#--entity pigpeppa \
#--num_gpus 8 \
#--max-epochs 100 \
