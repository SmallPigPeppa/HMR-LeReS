...
parser.add_argument("--ckpt_dir", type=str, default='./hmr-leres-ckpt')
parser.add_argument("--name", type=str, default='hmr-leres-cluster')
parser.add_argument("--project", type=str, default='HMR-LeReS-v6.0')
parser.add_argument("--entity", type=str, default='pigpeppa')
parser.add_argument("--offline", action="store_true")
parser.add_argument("--num_gpus", type=int, default=1)
parser.add_argument('--max-epochs', default=100, type=int, help='Total training epochs')
parser.add_argument('--num-workers', type=int, default=0, help='pytorch number worker.')
