...
class GTADataset(Dataset):
    ...
    def online_aug(self, anno_index):
        ...
        joints_2d = info_npz['joints_2d'][anno_index]
        joints_3d_cam = info_npz['joints_3d_cam'][anno_index]
        joints_3d_world = info_npz['joints_3d_world'][anno_index]
        world2cam_trans = info_npz['world2cam_trans'][anno_index]
        intrinsics = info_npz['intrinsics'][anno_index]
        ...
        # to torch, normalize
        rgb_torch = self.scale_torch(rgb_resize.copy())
        depth_resize = depth_resize[np.newaxis, :, :]
